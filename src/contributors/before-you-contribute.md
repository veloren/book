...
If you do not want to add your assets yourself skip to [Contributing Assets][1].
...
The codebase uses the [rebase strategy][2] therefore _do not_ merge master in your feature branch!
...
_Tip_: Incase of an error use `git status` to show next instructions.
...
2. Make sure to select `Delete source branch` for the MR.
   ...
   If you didn't bother following Rules For Commits above, please cleanup your branch now or consider setting the _squash commits_ option.<br/>
...
to important channels and access to the repository.<br/>
For future contributions develop on a feature branch, _in the Veloren repository_, such as our CI tests can run through and assure you that your work is correct.

[1]: #contributing-assets
